...
// WiFi credentials
#define WIFI_SSID "demo" // Change to your WiFi SSID
#define WIFI_PASSWORD "demo1234" // Change to your WiFi password



// Two API endpoints
// 1) Returns {"Birds":0,"Persons":0} (CV modelt that detects birds and persons and returns the count)
#define DETECTION_API_URL "http://ip/detection_data" // Replace with your actual detection data URL

// 2) Returns {"temperature":26.13,"door":"Open"}
#define DOOR_TEMP_API_URL "http://ip/data" // Replace with your actual door and temperature data URL
...
void setup() {
  ...
  display.setBrightness(0x08);  // Maximum brightness
  display.clear();
}
